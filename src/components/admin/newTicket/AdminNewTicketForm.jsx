...
export default function AdminNewTicketForm() {
  ...
  const { users, fetchUsers, categories, fetchCategories } = useAdminStore();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newTicketId = newTicketRes.data?.documentId || newTicketRes.documentId || newTicketRes.data?.id || newTicketRes.id;
